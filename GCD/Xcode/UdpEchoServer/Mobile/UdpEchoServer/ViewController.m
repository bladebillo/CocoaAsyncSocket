...
withFilterContext:(id)filterContext
{
    ...
    NSString *addrtext = [self addressFromData:address];
    
    if (msg && addrtext != nil && ![addrtext isEqualToString:@"0.0.0.0"])
    {
        ...
        [self logMessage:msg];
        [self logMessage:addrtext];
        
    } else if (msg) {
        /* ignore message without source IP */
    }
    else
    {
